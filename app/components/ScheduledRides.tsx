...
import { Admin,data } from "../(pages)/PickupRequests/ScheduledPickups/data-table"
...
export const columns: ColumnDef<Admin>[] = [
  ...
  {
    accessorKey: "AttemptsForSchedule",
    header: "Attempts For Schedule",
    cell: ({ row }) => (
      <div className="capitalize ">{row.getValue("AttemptsForSchedule")}</div>
    ),
  },
  {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize ">{row.getValue("PaymentOption")}</div>
    ),
  },
  {
    header: "Actions",
