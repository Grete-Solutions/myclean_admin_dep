...
import { Admin,data } from "../(pages)/TripRequests/CancelledRides/data-table"
...
export const columns: ColumnDef<Admin>[] = [
  ...
  }, 
  {
    ...
    header: "Cancelled By",
    cell: ({ row }) => (
      <div className="capitalize ">{row.getValue("CancelledBy")}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize ">{row.getValue("CancellationReason")}</div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <div className="capitalize ">{row.getValue("CancellationFee")}</div>
    ),
  },
    {
