...
import { ApprovePendingUsersConst,data  } from "@/app/(pages)/manageUsers/ApprovePendingUsers/ApprovedUsersConstants"

function generateAscendingSno(data:string) {
    return Array.from({ length: data.length }, (_, index) => index + 1);
  }
  
  export const columns: ColumnDef<ApprovePendingUsersConst>[] = [
    {
      accessorKey: "Sno",
      header: "Sno",
...
export function ApprovePendingUsersDataTable() {
