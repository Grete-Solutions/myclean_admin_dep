...
export function CancelledRideDataTable() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [CancelledResponse, UserResponse, DriverResponse] = await Promise.all([
          fetch('/lib/GET/PickupRequests/getCancelledPickups'),
        ...
        if (Array.isArray(CancelledData.product)) {
          setData(CancelledData.product);
        } else {
          setData([]);
        }
      } catch (error) {
